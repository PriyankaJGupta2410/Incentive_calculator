from repositories.model_repository import get_uploaded_files,get_user_details
import pandas as pd
from fastapi import UploadFile
from repositories.upload_respository import insert_sales_records,insert_incentive_records
