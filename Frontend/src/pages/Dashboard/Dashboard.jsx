        ...
        <nav className="db-nav">
          {menuItems.map((item) => (
            ...
            >
              ...
              {active === item.label && sidebarOpen && <span className="db-nav-pill" />}
            </button>
          ))}
        </nav>
          ...
          {sidebarOpen && (
            <div className="db-user">
              ...
              <div className="db-user-info">
                <span className="db-user-name">Admin User</span>
                <span className="db-user-role">Super Admin</span>
              </div>
            </div>
          )}
          {!sidebarOpen && <div className="db-avatar db-avatar-sm">A</div>}
        </div>
      </aside>
